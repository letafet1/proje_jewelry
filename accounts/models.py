...
from product.utils import create_slug_shortcode
...
class MyUser(AbstractBaseUser):
    ...
    name=models.CharField(max_length=40,verbose_name="Istifadeci adi",blank=True,null=True)
    surname=models.CharField(max_length=40,verbose_name="Istifadeci soyadi",blank=True,null=True)
